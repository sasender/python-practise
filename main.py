...
#programe demonstrate input and output
'''import re
...
print('Take your cash {1}, balance in your account is {0}'.format(cashValue,remainingAmount,end=" "))
# print('Take your cash',cash,remainingAmount,sep="@@",end="===")
# print('Thank You for using Atm',end=" ")
print('Thank You Sasender Reddy')'''
...
#while discusing input-Output
#using format we can write fancier out puts [place holder {}]


#opeartors programe python
